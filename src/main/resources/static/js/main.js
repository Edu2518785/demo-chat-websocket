$(document).ready(function(){
    ...
    function onMessageReceived(payload){
        ...
        if(message.tipo === 'UNIR'){
            messageElement.addClass("event-message").text(message.envio + " se ha unido al chat");
        } else if (message.tipo === 'DEJAR'){
            messageElement.addClass("event-message").text(message.envio + " se ha retirado del chat");
        } else {
    ...
    function actualizarTitulo() {
        if (unreadMessages > 0) {
            document.title = "ChismeChat (" + unreadMessages + " mensajes)";
        } else {
            document.title = "ChismeChat";
        }
    }
